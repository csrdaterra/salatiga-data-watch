...
const defaultCommodities: CommodityCategory[] = [
  { id: 1, name: "Beras Medium", description: "Beras kualitas medium", unit: "kg" },
  { id: 2, name: "Beras Premium", description: "Beras kualitas premium", unit: "kg" },
  { id: 3, name: "Kedelai Lokal", description: "Kedelai produksi lokal", unit: "kg" },
  { id: 4, name: "Kedelai Impor", description: "Kedelai impor", unit: "kg" },
  { id: 5, name: "Cabai Merah Keriting", description: "Cabai merah keriting segar", unit: "kg" },
  { id: 6, name: "Cabai Merah Besar", description: "Cabai merah besar segar", unit: "kg" },
  { id: 7, name: "Cabai Rawit Merah", description: "Cabai rawit merah segar", unit: "kg" },
  { id: 8, name: "Cabai Rawit Hijau", description: "Cabai rawit hijau segar", unit: "kg" },
  { id: 9, name: "Bawang Merah", description: "Bawang merah lokal", unit: "kg" },
  { id: 10, name: "Bawang Putih Honan", description: "Bawang putih jenis Honan", unit: "kg" },
  { id: 11, name: "Bawang Putih Kating", description: "Bawang putih jenis Kating", unit: "kg" },
  { id: 12, name: "Bawang Bombay", description: "Bawang bombay", unit: "kg" },
  { id: 13, name: "Gula Pasir Curah", description: "Gula pasir curah", unit: "kg" },
  { id: 14, name: "Gula Pasir Kemasan", description: "Gula pasir kemasan", unit: "kg" },
  { id: 15, name: "Minyak Goreng Curah", description: "Minyak goreng curah", unit: "liter" },
  { id: 16, name: "Minyak Goreng Premium", description: "Minyak goreng premium", unit: "liter" },
  { id: 17, name: "Minyak Goreng Minyakita", description: "Minyak goreng merk Minyakita", unit: "liter" },
  { id: 18, name: "Tepung Terigu Protein Tinggi", description: "Tepung terigu protein tinggi", unit: "kg" },
  { id: 19, name: "Tepung Terigu Protein Sedang", description: "Tepung terigu protein sedang", unit: "kg" },
  { id: 20, name: "Tepung Terigu Protein Rendah", description: "Tepung terigu protein rendah", unit: "kg" },
  { id: 21, name: "Daging Ayam Ras", description: "Daging ayam ras segar", unit: "kg" },
  { id: 22, name: "Daging Ayam Kampung", description: "Daging ayam kampung segar", unit: "kg" },
  { id: 23, name: "Daging Sapi Bagian Paha Belakang", description: "Daging sapi paha belakang", unit: "kg" },
  { id: 24, name: "Daging Sapi Bagian Paha Depan", description: "Daging sapi paha depan", unit: "kg" },
  { id: 25, name: "Daging Sapi Bagian Sandung Lamur", description: "Daging sapi sandung lamur", unit: "kg" },
  { id: 26, name: "Daging Sapi Bagian Tetelan", description: "Daging sapi tetelan", unit: "kg" },
  { id: 27, name: "Telur Ayam Ras", description: "Telur ayam ras segar", unit: "kg" },
  { id: 28, name: "Telur Ayam Kampung", description: "Telur ayam kampung segar", unit: "kg" },
  { id: 29, name: "Ikan Bandeng", description: "Ikan bandeng segar", unit: "kg" },
  { id: 30, name: "Ikan Kembung", description: "Ikan kembung segar", unit: "kg" },
  { id: 31, name: "Ikan Tongkol/Tuna/Cangkalang", description: "Ikan tongkol, tuna, atau cangkalang", unit: "kg" },
  { id: 32, name: "Ikan Teri Asin", description: "Ikan teri asin", unit: "kg" },
  { id: 33, name: "Udang Segar", description: "Udang segar", unit: "kg" },
  { id: 34, name: "Tempe Kedelai", description: "Tempe kedelai", unit: "kg" },
  { id: 35, name: "Tahu Mentah Putih", description: "Tahu mentah putih", unit: "kg" },
  { id: 36, name: "Tomat", description: "Tomat segar", unit: "kg" },
  { id: 37, name: "Ketimun", description: "Ketimun segar", unit: "kg" },
  { id: 38, name: "Sawi Hijau", description: "Sawi hijau segar", unit: "kg" },
  { id: 39, name: "Kangkung", description: "Kangkung segar", unit: "kg" },
  { id: 40, name: "Kacang Panjang", description: "Kacang panjang segar", unit: "kg" },
  { id: 41, name: "Kentang", description: "Kentang segar", unit: "kg" },
  { id: 42, name: "Pisang Lokal", description: "Pisang lokal", unit: "kg" },
  { id: 43, name: "Jeruk Lokal", description: "Jeruk lokal", unit: "kg" },
  { id: 44, name: "Jagung Pipilan", description: "Jagung pipilan", unit: "kg" },
  { id: 45, name: "Mie Intan Kari", description: "Mie instan rasa kari", unit: "bungkus" },
  { id: 46, name: "Garam Halus", description: "Garam halus", unit: "kg" },
  { id: 47, name: "Susu Kental Manis Kaleng (Frisian Flag 370g)", description: "Susu kental manis Frisian Flag 370g", unit: "kaleng" },
  { id: 48, name: "Susu Bubuk (Dancow 390gr)", description: "Susu bubuk Dancow 390gr", unit: "pak" },
  { id: 49, name: "Ketela Pohon", description: "Ketela pohon", unit: "kg" },
  { id: 50, name: "Kacang Hijau", description: "Kacang hijau", unit: "kg" }
];
